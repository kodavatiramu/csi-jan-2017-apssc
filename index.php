...
<body>
        ...
        <div id="header2" style="margin-bottom: 0px; padding-bottom: 0px;" class="row">
            ...
            <div style="margin-bottom: 0px; padding-bottom: 0px;"  class="col-md-6 w3-center col-sm-12">
               <br><hr>
                ...
                <br>
				<h1 style="align-self: center; color: yellow;font-size: 40px;font-family: 'Rancho', cursive;" class="w3-center tlt">On 6th and 7th Jan 2017</h1><hr>
            </div>
            <div class="col-md-3 w3-center hidden-sm-down" style="margin-bottom: 0px; padding-bottom: 0px;" >
    ...
    <div class="row">
        ...
        <div class="row">
            ...
            <div role="button" id="event-pp" onclick="window.location.href='workshop.html'" class=" animated fadeInRightBig w3-card-8 w3-padding-tiny w3-hover-amber w3-cyan col-md-3 col-sm-12">
                <div class="w3-container w3-center">
 ...
 <div class="row">
            ...
            <div role="button" id="event-pp" onclick="window.location.href='cam.html'" class=" animated fadeInLeftBig w3-card-8 w3-padding-tiny w3-hover-amber w3-yellow col-md-3 col-sm-12">
                <div class="w3-container w3-center">
                    <h3>Pic A Cam</h3>
