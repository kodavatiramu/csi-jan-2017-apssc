...
//region getV<script type="text/javascript">
$("#eventbtn").click(function () {
    $(".eventBlock").toggleClass("eventright");
    $(".applicationBlock").removeClass("eventright");
});

$("#appbtn").click(function () {
    $(".applicationBlock").toggleClass("eventright");
    $(".eventBlock").removeClass("eventright");
});
...
$('#container1 p:gt(0)').hide();
setInterval(function () {
    $('#container1 p:first-child').fadeOut('slow')
